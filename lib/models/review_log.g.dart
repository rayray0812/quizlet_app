...
_$ReviewLogImpl _$$ReviewLogImplFromJson(Map<String, dynamic> json) =>
    _$ReviewLogImpl(
      ...
      chosenDistractorId: json['chosenDistractorId'] as String?,
...
Map<String, dynamic> _$$ReviewLogImplToJson(_$ReviewLogImpl instance) =>
    <String, dynamic>{
      ...
      'responseLatencyMs': instance.responseLatencyMs,
      'chosenDistractorId': instance.chosenDistractorId,
      'predictedRetrievability': instance.predictedRetrievability,
