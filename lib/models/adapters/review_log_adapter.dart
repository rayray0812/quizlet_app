...
class ReviewLogAdapter extends TypeAdapter<ReviewLog> {
  ...
  ReviewLog read(BinaryReader reader) {
    ...
    return ReviewLog(
      ...
      reviewType: map['reviewType'] as String? ?? 'srs',
      speakingScore: map['speakingScore'] as int?,
      sessionId: map['sessionId'] as String?,
      responseLatencyMs: map['responseLatencyMs'] as int?,
      chosenDistractorId: map['chosenDistractorId'] as String?,
      predictedRetrievability:
          (map['predictedRetrievability'] as num?)?.toDouble(),
  ...
  void write(BinaryWriter writer, ReviewLog obj) {
    writer.writeMap({
      ...
      'speakingScore': obj.speakingScore,
      'sessionId': obj.sessionId,
      'responseLatencyMs': obj.responseLatencyMs,
      'chosenDistractorId': obj.chosenDistractorId,
      'predictedRetrievability': obj.predictedRetrievability,
