-- Fix: auth.users.email is varchar, but the function return type declares text.
-- PostgreSQL strict type checking rejects the mismatch. Cast explicitly.
...
begin
  ...
  where normalized_search = ''
    ...
    or coalesce(u.email, '')::text ilike '%' || normalized_search || '%'
